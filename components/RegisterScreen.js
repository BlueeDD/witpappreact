...
const RegisterScreen = () => {
    ...
    const getCitiesData = async () => {
        ...
        const response = await fetch('http://whereisthepubcrawl.com/API/getCities.php', {
            method: 'GET',
            headers: {
    ...
    const handleCreateAccountPress = async () => {
        if (!isValid) {
            ...
            if (email !== "" && name !== "") {
                const response = await fetch('http://whereisthepubcrawl.com/API/register.php', { // 'https://whereisthepubcrawl.com/API/login.php'
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
